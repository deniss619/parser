...
Сохраните в базу данных страницы со статьями (промежуточные не нужны).
...
for url in hrefs:
    ...
    for topic in topics:
        ...
        insert_query = f"""INSERT INTO ex3(title, url, content) VALUES ('{driver.title}', '{topic}', '{content}')"""
